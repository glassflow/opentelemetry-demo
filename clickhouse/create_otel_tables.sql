-- ClickHouse tables for OpenTelemetry data compatible with ClickStack/HyperDX
-- Based on official ClickStack schema: https://clickhouse.com/docs/use-cases/observability/clickstack/ingesting-data/schemas

-- Create database if it doesn't exist
CREATE DATABASE IF NOT EXISTS default;

-- Use the default database (ClickStack standard)
USE default;

-- Table for OpenTelemetry Logs (ClickStack format)
...
-- Table for OpenTelemetry Traces (ClickStack format)
...
-- Table for OpenTelemetry Gauge Metrics (ClickStack format)
...
-- Table for OpenTelemetry Sum Metrics (ClickStack format)
...
-- Table for OpenTelemetry Histogram Metrics (ClickStack format)
...
-- Table for OpenTelemetry Summary Metrics (ClickStack format)
